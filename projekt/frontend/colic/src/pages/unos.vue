<template>
    <q-page padding="">
      <div class="row" style="justify-content: center;">
        ...
        inline-label
      >
        <q-tab name="unos" label="Unos" />
        <q-tab name="pregled" label="Pregled" />
        <q-tab name="kviz" label="Kviz" />
      </q-tabs>
      </div>
      </div>
        <div class="row space-between">
            <div clas="col-6" style="width: 45%; margin-right: 5%;">
                    <q-input outlined v-model="text" label="Hrvatski nazv" :dense="dense" />
            </div>
            ...
            <div class="col-3" style="width: 27.5%; margin-right: 5%;">
                ...
                <q-btn-dropdown label="Botanička porodica:">
                  ...
                  <q-list link>
                    <q-item>
                      <q-item-main>
                        <q-item-tile>Botanička porodica:</q-item-tile>
                      </q-item-main>
                    </q-item>
                  </q-list>
                </q-btn-dropdown>
